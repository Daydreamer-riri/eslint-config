...
export { EcmaVersion, ReportDescriptor, ReportFixFunction, RuleContext, RuleFixer, RuleFunction, RuleListener, Scope, SourceCode } from '@typescript-eslint/utils/ts-eslint'
